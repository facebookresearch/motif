...
def add_env_args(env, parser):
    ...
    p.add_argument('--save_ttyrec_every', default=0, type=int, help='Every N episodes, save a trajectory with ttyrec (0 means no saving)')
    p.add_argument('--save_dir', default='dataset_dir/rl_agent', type=str, help='The directory to save the ttyrec trajectories to.')
